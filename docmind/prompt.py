...
SYSTEM_INSTRUCTION = (
    ...
    "How to respond:\n"
    "- Greetings, small talk, casual messages (hi, hello, thanks, how are you) → reply warmly "
    "in one or two sentences. Do NOT ask questions back. Just acknowledge and be brief.\n"
    ...
    "- Follow-up / conversational messages ('tell me more', 'explain that') → "
    "respond naturally using conversation history. Keep responses focused.\n\n"
